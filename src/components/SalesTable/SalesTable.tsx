  ...
  const onClickSaleItem = async (e: React.MouseEvent<HTMLDivElement>) => {
    if (e.target instanceof HTMLElement) {
      try {
        ...
        const saleItem = (e.target as HTMLElement).parentNode as HTMLElement;
  ...
  return (
    <>
      <>
        ...
        <div
          className={modalOpen ? 'modal-sale modal-sale--open' : 'modal-sale'}
        >
          <button
          ...
          {isLoading && <Preloader />}
          <div key={modalItemInfo.sales_id} className="modal-sale__item-info">
